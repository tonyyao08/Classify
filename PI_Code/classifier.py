...
class Classifier:
    ...
    # def get_matched_label_2(self, labels, detect_text_response):
    #     superString = " ".join(detect_text_response)
    #     confidences = []

    # def calculateConfidence(meta, superString):
    #     totalCharacters = 0
    #     ratios = []
    #     for metaValue in meta:
    #         totalCharacters += len(metaValue)
    #         ratios.append(
    #             (metaValue, fuzz.partial_ratio(metaValue, superString)))
